...
assert_equal("GIT_REPOSITORY;https://github.com/cpm-cmake/CPM.cmake.git" "${args}")

cpm_parse_add_package_single_arg("gh:cpm-cmake/CPM.cmake@1.2.3" args)
assert_equal("GIT_REPOSITORY;https://github.com/cpm-cmake/CPM.cmake.git;VERSION;1.2.3" "${args}")

cpm_parse_add_package_single_arg("gh:cpm-cmake/CPM.cmake#master" args)
assert_equal("GIT_REPOSITORY;https://github.com/cpm-cmake/CPM.cmake.git;GIT_TAG;master" "${args}")

cpm_parse_add_package_single_arg("gh:cpm-cmake/CPM.cmake@0.20.3#asdf" args)
assert_equal(
  "GIT_REPOSITORY;https://github.com/cpm-cmake/CPM.cmake.git;VERSION;0.20.3;GIT_TAG;asdf" "${args}"
)

cpm_parse_add_package_single_arg("gh:a/b#c@d" args)
assert_equal("GIT_REPOSITORY;https://github.com/a/b.git;GIT_TAG;c;VERSION;d" "${args}")

cpm_parse_add_package_single_arg("gh:foo#c@d" args)
assert_equal("GIT_REPOSITORY;https://github.com/foo.git;GIT_TAG;c;VERSION;d" "${args}")

cpm_parse_add_package_single_arg("gh:Foo@5" args)
assert_equal("GIT_REPOSITORY;https://github.com/Foo.git;VERSION;5" "${args}")

cpm_parse_add_package_single_arg("gl:foo/bar" args)
assert_equal("GIT_REPOSITORY;https://gitlab.com/foo/bar.git" "${args}")

cpm_parse_add_package_single_arg("gl:foo/Bar" args)
assert_equal("GIT_REPOSITORY;https://gitlab.com/foo/Bar.git" "${args}")

cpm_parse_add_package_single_arg("bb:foo/bar" args)
assert_equal("GIT_REPOSITORY;https://bitbucket.org/foo/bar.git" "${args}")
...
cpmdefineurischeme(
  ALIAS "af" LONG_NAME "ARTIFACTORY_PKG" URI_ROOT "https://my.company.artifatory/pkgs"
)

cpm_parse_add_package_single_arg("ir:somegroup/somerepo@0.20.3#asdf" args)
assert_equal(
  "GIT_REPOSITORY;git@company.internal.gitserver/somegroup/somerepo.git;VERSION;0.20.3;GIT_TAG;asdf"
  "${args}"
)

cpm_parse_add_package_single_arg("af:somegroup/someitem.zip" args)
assert_equal("URL;https://my.company.artifatory/pkgs/somegroup/someitem.zip" "${args}")
